...
#define CFLAGS      "-std=c99 -W -Wall -O2 -march=native -DNDEBUG "
#define CXXFLAGS    "-export-dynamic -std=c++17 -Wno-c++11-compat -W -Wall -O2 -march=native -DNDEBUG  -Wno-literal-suffix"
